...
const sectionPetsitters = createHtmlElement(
  "section",
  "section-common-petsitters"
);
...
function renderPetsitMainPage() {
  ...
  const topTexPetsitContainer = createHtmlElement(
    "div",
    "top-text-petsit-container"
  );
  topBlockPetsit.append(topTexPetsitContainer);
  const tittleTopPetsitBlock = createHtmlElement(
    "h2",
    "title-top-petsit-block",
    "",
    "Become a petsitter and earn money doing what you love!"
  );
  topTexPetsitContainer.append(tittleTopPetsitBlock);
  const topTextPetsit = createHtmlElement(
    "div",
    "top-text-petsit",
    "",
    "Petsi is a platform for people who love animals. We support You and help you develop Your business. Become a professional petsitter together with us!"
  );
  ...
  if (imgTopPetsit instanceof HTMLImageElement) {
    imgTopPetsit.src =
      "https://petsy.pl/_next/image/?url=%2Fimages%2Flandings%2Fpetsitter_hero.jpg&w=1920&q=75";
    imgTopPetsit.alt = "girl and dog";
  }
  const petsitBlock1 = createPetsitBlock(
    "Your business card",
    "Petsi's pet sitter profile is your public business card and will help you establish credibility as a pet sitter in the eyes of pet owners.",
    "https://petsy.pl/_next/image/?url=%2Fimages%2Flandings%2Fpetsitter_profile.jpg&w=1920&q=75",
    "block-revert"
  );
  sectionPetsitters.append(petsitBlock1);
  const petsitBlock2 = createPetsitBlock(
    "Transparent billing rules",
    "Petsi is completely free for owners and for caregivers. We only make a living from commission on orders, which we then use to develop the portal and promote the petsitter profession, which will translate into the number of orders you acquire.",
    "https://petsy.pl/_next/image/?url=%2Fimages%2Flandings%2Fpetsitter_accounting.jpg&w=1920&q=75"
  );
  sectionPetsitters.append(petsitBlock2);
  const petsitBlock3 = createPetsitBlock(
    "Business support",
    "We do everything to help you grow your business. Extensive panel, training, simple registration and verification. Take care of your pets and we'll take care of everything around you!",
    "https://petsy.pl/_next/image/?url=%2Fimages%2Flandings%2Fpetsitter_support.jpg&w=1920&q=75",
    "block-revert"
  );
...
function createPetsitBlock(
  ...
  const litleTitlePetsitBlock = createHtmlElement(
    "h5",
    "little-title-petsit-block",
    "",
    "PETSI"
  );
  textPetsitBlock.append(litleTitlePetsitBlock);
  const titlePetsitBlock = createHtmlElement(
    "h2",
    "petsit-title-block",
    "",
    title
  ...
  const commonTextPetsitBlock = createHtmlElement(
    "div",
    "common-text-petsit-block",
    "",
    commonText
  );
  ...
  const boxImgPetsitBlock = createHtmlElement(
    "div",
    "block-box-img-petsit-main"
  );
...
function createBtnCreatAcc() {
  const btnCreateAcc = createHtmlElement(
    "a",
    "btn-create-account",
    "",
    "Create account"
...
function createContactPetsitSection() {
  const contactPetsitMainSection = createHtmlElement(
    "section",
    "section-contact-petsit-main-page"
  );
  const contactPetsitWrapper = createHtmlElement(
    "div",
    "contact-petsitter-wrapper-main-page"
  );
  contactPetsitMainSection.append(contactPetsitWrapper);
  const inputTextContactContainer = createHtmlElement(
    "div",
    "input-text-contact-petsit-container"
  );
  ...
  const contactCommonText = createHtmlElement(
    "div",
    "common-text-petsit-block",
    "",
    "Sign up and receive once a month tips, discounts and news straight from us"
  );
  contactTitle.after(contactCommonText);
  const inputContactWrapper = createHtmlElement(
    "div",
    "input-contact-petsit-main-wrapper"
  );
  ...
  const btnSignUp = createHtmlElement(
    "button",
    "btn-sign-up-contact",
    "",
    "Subscribe"
  ...
  const emailTextError = createHtmlElement(
    "p",
    "email-text-error-petsit-contact-main",
    "",
  ...
  if (emailContactInput instanceof HTMLInputElement) {
    ...
    btnSignUp.addEventListener("click", () => {
      if (
        !emailContactInput.checkValidity() &&
  ...
  const imgContactWrap = createHtmlElement(
    "div",
    "img-contact-main-petsit-wrapper"
  );
  ...
  if (imgContact instanceof HTMLImageElement) {
    imgContact.src =
      "https://petsy.pl/_next/image/?url=%2Fimages%2Flandings%2Fpetsitter_newsletter.jpg&w=1200&q=75";
