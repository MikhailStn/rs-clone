...
function renderRegistrPage(role: string){
    ...
    const inputPassword = createHtmlElement('input', 'input-password-registration input-registration', 'password');
    ...
    textQuestion.innerHTML = '<p>Already have an account on Petsy?<a class="link-sign-in-registration" href = "/auth/login">Sign in</a></p>';
